		...
		<table class="table table-bordered table-hover">
          ...
          <th>Roles</th>
            ...
            <td>{{ implode(', ', $user->roles()->get() ->pluck('name')->toArray())}}</td>
						...
						<td>@if($user->approved == 0) Inactive @else Active @endif</td> 

						<td><button type="button" class="btn btn-outline-primary"><a href="{{ route('approved', ['id'=>$user->id]) }}" style="color: black;">@if($user->approved == 1) Inactive @else Active @endif</a></button></td>
